...
//        System.out.println("InValid=" + (input.length - valid));
//
//    }
        ...
        for (int i = 0; i < input.length; i++) {
            ...
            boolean isMax = false;
            for (int j = 0; j < tokens[2].length(); j++) {
                if (chr == tokens[2].charAt(min-1)) {
                    isMin = true;
                }
                if (chr == tokens[2].charAt(max-1)) {
                    isMax = true;
                }
        ...
        System.out.println("InValid1=" + (input.length - valid1));
        System.out.println("Valid2=" + valid2);
        System.out.println("InValid2=" + (input.length - valid2));
